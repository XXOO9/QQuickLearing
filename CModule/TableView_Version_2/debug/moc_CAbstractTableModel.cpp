...
#include "../DataModel/CAbstractTableModel.h"
...
QT_MOC_LITERAL(1, 20, 9), // "CellRoles"
QT_MOC_LITERAL(2, 30, 16) // "Cell_DisplayRole"

    },
    "CAbstractTableModel\0CellRoles\0"
    "Cell_DisplayRole"
};
...
static const uint qt_meta_data_CAbstractTableModel[] = {
 ...
 // enum data: key, value
       2, uint(CAbstractTableModel::Cell_DisplayRole),
