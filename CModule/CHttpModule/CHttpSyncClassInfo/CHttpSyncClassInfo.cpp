...
CHttpSyncClassInfo::CHttpSyncClassInfo(QString timeSatmp)
{
...
int CHttpSyncClassInfo::classInfoCount()
{
    return m_ret.size();
}

QMap<QString, QString> CHttpSyncClassInfo::getClassGroupInfo(int index)
{
